...
#include "imageData\BACKGROUND.c"
#include "imageData\BACKGROUND_RED.c"
#include "imageData\ICON.c"



#define IMG_BW_BUFFER        (uint8_t *) & gImage_wolf
#define IMG_RED_BUFFER       (uint8_t *) & gImage_wolf_red
